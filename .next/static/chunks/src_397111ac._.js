(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/src_397111ac._.js", {
    ...
    const filteredAndSortedIncidents = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "IncidentList.useMemo[filteredAndSortedIncidents]": ()=>{
            ...
            if (dateRange?.from && dateRange?.to) {
                const interval = {
                    start: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$startOfDay$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["startOfDay"])(dateRange.from),
                    end: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$endOfDay$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["endOfDay"])(dateRange.to)
                };
                filtered = filtered.filter({
                    "IncidentList.useMemo[filteredAndSortedIncidents]": (incident)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$isWithinInterval$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isWithinInterval"])(incident.reportedDate, interval)
                }["IncidentList.useMemo[filteredAndSortedIncidents]"]);
            } else if (dateRange?.from) {
                // Handle case where only 'from' date is selected
                const startDate = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$startOfDay$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["startOfDay"])(dateRange.from);
                filtered = filtered.filter({
                    "IncidentList.useMemo[filteredAndSortedIncidents]": (incident)=>incident.reportedDate >= startDate
                }["IncidentList.useMemo[filteredAndSortedIncidents]"]);
            }
            ...
            if (searchQuery) {
                ...
                filtered = filtered.filter({
                    "IncidentList.useMemo[filteredAndSortedIncidents]": (incident)=>incident.title.toLowerCase().includes(lowerCaseQuery) || incident.description.toLowerCase().includes(lowerCaseQuery) || incident.tags && incident.tags.some({
                            "IncidentList.useMemo[filteredAndSortedIncidents]": (tag)=>tag.toLowerCase().includes(lowerCaseQuery)
                        }["IncidentList.useMemo[filteredAndSortedIncidents]"]) || incident.comments && incident.comments.some({
                            "IncidentList.useMemo[filteredAndSortedIncidents]": (comment)=>comment.text.toLowerCase().includes(lowerCaseQuery) || comment.author.toLowerCase().includes(lowerCaseQuery)
                        }["IncidentList.useMemo[filteredAndSortedIncidents]"]) || findUserNameById(incident.assigneeId).toLowerCase().includes(lowerCaseQuery) // Search assignee name
                }["IncidentList.useMemo[filteredAndSortedIncidents]"]);
            }
            // Apply severity filter
            if (filterSeverity !== "All") {
                filtered = filtered.filter({
                    "IncidentList.useMemo[filteredAndSortedIncidents]": (incident)=>incident.severity === filterSeverity
                }["IncidentList.useMemo[filteredAndSortedIncidents]"]);
            }
            // Apply status filter
            if (filterStatus !== "All") {
                filtered = filtered.filter({
                    "IncidentList.useMemo[filteredAndSortedIncidents]": (incident)=>incident.status === filterStatus
                }["IncidentList.useMemo[filteredAndSortedIncidents]"]);
            }
            ...
            if (filterAssignee !== "All") {
                if (filterAssignee === "unassigned") {
                    filtered = filtered.filter({
                        "IncidentList.useMemo[filteredAndSortedIncidents]": (incident)=>!incident.assigneeId
                    }["IncidentList.useMemo[filteredAndSortedIncidents]"]);
                } else {
                    filtered = filtered.filter({
                        "IncidentList.useMemo[filteredAndSortedIncidents]": (incident)=>incident.assigneeId === filterAssignee
                    }["IncidentList.useMemo[filteredAndSortedIncidents]"]);
                }
            }
            // Apply sorting
            const sorted = [
                ...
                "IncidentList.useMemo[filteredAndSortedIncidents].sorted": (a, b)=>{
                    switch(sortOrder){
                        case "oldest":
            ...
            }["IncidentList.useMemo[filteredAndSortedIncidents].sorted"]);
            return sorted;
        }
    }["IncidentList.useMemo[filteredAndSortedIncidents]"], [
        incidents,
...
//# sourceMappingURL=src_397111ac._.js.map